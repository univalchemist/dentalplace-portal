...
<html lang="en">
  <head>   
  <title><?php echo strtoupper($this->uri->segment(1));?> | Dental Place</title>
  <meta charset="utf-8">
  ...
  <link rel="icon" href="<?php echo base_url('assets/img/Favicon-dental-Place.jpg'); ?>" type="image/gif" sizes="16x16">
