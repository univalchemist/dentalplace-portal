...
<input class="input100" type="password"  placeholder="New password" name="new" required >

<img src="<?php echo base_url('img/ic_lock_24px.png')?>">

</div>

<div class="wrap-input100 validate-input m-b-23" data-validate="Username is required">

<input class="input100" type="password"  placeholder="Confirm password" name="confirm" required >
