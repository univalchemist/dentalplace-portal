...
<div class="limiter recover_sec rmember">
		<div class="container">
...
<a href="mailto:johndoe@gmail.com" target="_blank"><?php $username = $_SESSION['usersss'] ['user_email'];
...
<a href="<?php echo base_url('Admin/resend')?>">Resend code</a>

</div>
<div class="goback_texts">
<p><a href="<?php echo base_url('admin-login')?>">Go back to Login</a></p>
</div>
</form>
			</div>
		</div>
